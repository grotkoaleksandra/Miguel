...
export function VideoHero({
  ...
  useEffect(() => {
    // Start reveal — preloader fades, text begins sliding in simultaneously
      ...
      <section className="relative min-h-screen flex flex-col justify-between overflow-hidden bg-[#e8e8e8]">
          ...
          <div className="w-full max-w-[1800px] mx-auto">
            <h1 className="leading-[0.88] tracking-[-0.04em]">
              {[line1, line2, line3].map((line, i) => (
                ...
                >
                  <span
                    className={`block text-[13vw] md:text-[9vw] transition-transform duration-[1.2s] ease-[cubic-bezier(0.16,1,0.3,1)] ${
                      i === 2
                        ? "font-display italic text-foreground/70"
        ...
        <div className="px-6 md:px-12 lg:px-20 pb-8 md:pb-12">
          <div className="max-w-[1800px] mx-auto">
            <div
              className={`flex items-end justify-between border-t border-foreground/[0.08] pt-6 transition-all duration-[0.8s] ease-out ${
